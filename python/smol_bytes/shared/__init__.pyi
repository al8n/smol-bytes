...
class Bytes:
    ...
    Stores <=62 bytes inline; larger data uses reference-counted heap storage
    with zero-copy cloning. Preserves heap allocations for fast ``bytes::Bytes`` interop.
    """
...
class Utf8Bytes:
    """Immutable UTF-8 string using the Shared strategy.
